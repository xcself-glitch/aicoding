...
class Backtester:
    def __init__(self, initial_capital: float = 10000.0):
        ...
        self.equity_curve = []
        self.position_pct = 0.80  # 每次80%仓位
...
def print_report(result, initial_capital, days):
    print("\n" + "="*80)
    print("📊 ETHUSDT V10策略回测报告 (V4优化版 - 80%仓位)")
    print("="*80)
    print("🎯 目标: 周收益50%+ | 胜率60%+")
    print("-"*80)
...
def main():
    print("🚀 ETHUSDT V10策略回测 - V4优化版")
    print("="*80)
    print("🎯 核心特性:")
    print("   1️⃣ 保持V4入场逻辑不变(胜率50%)")
    print("   2️⃣ 仓位提升到80%")
    print("   3️⃣ 盈亏比3:1，止损1%止盈3%")
    print("="*80)
